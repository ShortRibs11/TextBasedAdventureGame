...
C = object.c misc.c noun.c location.c move.c openclose.c reachable.c toggle.c inventory.c inventory2.c parser.c match.c main.c
H = object.h misc.h noun.h location.h move.h openclose.h reachable.h toggle.h inventory.h inventory2.h parser.h match.h
